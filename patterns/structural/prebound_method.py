...
def demonstrate_prebound_methods():
    ...
    # --- Manual binding via descriptor protocol (via instance attribute) ---
    bound_via_descriptor = proc.process_text
    bound_via_descriptor("Bound via descriptor")

    # Or, call descriptor directly without assignment:
    Processor.process_text.__get__(proc, Processor)("Bound via descriptor inline")  # pylint: disable=no-value-for-parameter
