...
## Summary
A self-contained demonstration of the 3-Tier Architecture pattern in Python, showcasing data, logic, and presentation layers.

## Docstrings
- Save a task to the data store.
- Retrieve all stored tasks.
- Add a task after validation.
- Raises ValueError if the task is empty or invalid.
- Retrieve all tasks.
- Display the main menu.
- Main CLI loop.
